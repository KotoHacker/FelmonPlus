...
package ru.aniby.felmon.discord.rpclib;
...
public class DiscordRichPresence extends Structure
{
    ...
    public static String arrayButtons(String[]... buttons) {
        JSONArray array = new JSONArray();
        for(String[] button : buttons) {
            JSONObject jsonButton = new JSONObject();
            jsonButton.put("label", button[0]);
            jsonButton.put("url", button[1]);
            array.put(jsonButton);
        }
    ...
    public boolean equals(Object o)
    {
        ...
        return startTimestamp == presence.startTimestamp
                ...
                && Objects.equals(buttons, presence.buttons);
    }
    ...
    public int hashCode()
    {
        return Objects.hash(state, details, startTimestamp, endTimestamp, largeImageKey, largeImageText, smallImageKey,
                smallImageText, partyId, partySize, partyMax, matchSecret, joinSecret, spectateSecret, buttons, instance);
    }
